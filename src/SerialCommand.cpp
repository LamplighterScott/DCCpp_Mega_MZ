...
// Serial0 is used for communications between Arduino:PC
// Serial1 is used to communications between Arduino:DF Player Mini
// Serial3 is used for communications between Arduino:ESP8266/ESP-01
...
void SerialCommand::playSound(char *soundData){
  ...
  if (sscanf(soundData, "%i %i",&functionAction, &functionNumber) == 2) {
